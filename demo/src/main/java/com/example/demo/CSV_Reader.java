...
public class CSV_Reader {
    public static ArrayList<Course> readCourses() throws IOException {
        ...
        while ((line = br.readLine()) != null) {
            ...
            courses.add(new Course(data[0], data[1], Integer.parseInt(data[2]), data[3], readStudentsFromCurrentLineInCSV(data)));
    ...
    public static ArrayList<String> readStudentsFromCurrentLineInCSV(String[] data) throws  IOException {
